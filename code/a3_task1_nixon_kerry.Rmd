...
# Data Viz: Finalized Cloropleth Plot

# Using ggplot to generate a cloropleth plot using the number of oil spills by county as the fill color
...
**Figure 2.** The above cloropleth plot of California shows the number of inland oil spills that occurred in 2008 by county. Inland spills include both land and freshwater incidents. Counties without oil spill data are colored white. Darker colors correspond with a higher number of oil spills.
